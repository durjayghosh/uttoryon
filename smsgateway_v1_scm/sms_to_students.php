                  ...
                  <div class="form-group">
	                  ...
	                  <div class="form-group">
						...
						?>
					        ...
					        <br>
					        <div class="form-group">
            				<label for="select_student" class="col-lg-4 control-label">Selects Students Mobile No.</label>
            				<div class="col-lg-6">
				           		 	
				                    <td><select multiple="multiple" data-rel="chosen" class="form-control" id="select_student" name="mobile_no[]" style="display:none">
										<select>
									</td>
												...
												var value=$(this).val();
													...
													if(value=="displaynone"){
														...
														$('#tl_td').hide();
																...
																$('#select_student').show();
																$('#tl_td').show();
																$.post('select_students.php', {class_id:value}, function(data){
