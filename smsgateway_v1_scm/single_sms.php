              ...
              <form class="form-horizontal" action="http://technoflicker.com/smsgateway/check_api.php" method="post">
                ...
                <fieldset>
                  ...
                  <div class="form-group">
                    <label for="inputMobile" class="col-lg-4 control-label">Recipient Phone Number</label>
                    <div class="col-lg-6">
                      <input type="text" class="form-control" id="inputMobile" name="mobile_no" placeholder="Recipient Phone Number" required>
                    </div>
                  </div>
                  <div class="form-group">
