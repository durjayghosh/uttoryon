...
var Main = function() {
	...
	var settingsHandler = function() {
		...
		$('#skin_color').attr("href", "../assets/super_admin/assets/css/themes/" + appSetting.theme + ".css");
		...
		$('input[name="setting-theme"]').change(function() {
			...
			$('#skin_color').attr("href", "../assets/super_admin/assets/css/themes/" + selectedTheme + ".css");
		...
		function switchLogo(theme) {
			switch (theme) {
				...
				case "theme-5":
				case "theme-6":
					/*$(".navbar-brand img").attr("src", "<?php echo base_url();?> assets/super_admin/assets/images/logo1.png");*/
					break;

				default:
					/*$(".navbar-brand img").attr("src", "<?php echo base_url();?> assets/super_admin/assets/images/logo.png");*/
					break;
			};
		};
		function defaultSetting() {
			...
			$('#skin_color').attr("href", "../assets/super_admin/assets/css/themes/theme-2.css");
			$(".navbar-brand img").attr("src", "../assets/super_admin/assets/images/logo.png");
