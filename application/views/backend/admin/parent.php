            ...
            <td>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                        ...
                        <!-- PARENT ADDING LINK -->
                        <li>
                            <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_parent_add/<?php echo $row['student_id'];?>/<?php echo $row['class_id'];?>');">
                        ...
                        <!-- PARENT EDITING LINK -->
                        <li>
                            <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_parent_edit/<?php echo $parent_info->parent_id;?>/<?php echo $class_id;?>');">
                        ...
                        <li>
                            <a href="#" onclick="confirm_modal('<?php echo base_url();?>super_admin/parent/delete/<?php echo $parent_info->parent_id;?>/<?php echo $class_id;?>');">
