	...
	<div class="col-md-12">
		<div class="" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open('teacher/exam/edit/do_update/'.$row['exam_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
            <div class="padded">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="date" class="datepicker form-control" name="date" value="<?php echo $row['date'];?>"/>
                    </div>
                </div>
                <div class="form-group">
