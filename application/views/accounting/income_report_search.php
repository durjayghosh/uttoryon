...
<!-- start: FIELDSET -->
						<div class="container-fluid container-fullw bg-white">
							...
							<!-- end of count bar -->
								<div class="col-md-12">
									<h5 class="over-title"><span class="text-bold">Income Reports || From: <?=date('d/M/Y',strtotime($start_date))?> To: <?=date('d/M/Y',strtotime($end_date))?> </span> || <a href="javascript:window.print()">Print</a> </h5>
