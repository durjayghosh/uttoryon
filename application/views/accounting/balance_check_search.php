...
<!-- start: FIELDSET -->
						<div class="container-fluid container-fullw bg-white">
							...
							<!-- end of count bar -->
								<div class="col-md-12">
									<h5 class="over-title"><span class="text-bold">Balance Check || From: <?=date('d/M/Y',strtotime($start_date))?> To: <?=date('d/M/Y',strtotime($end_date))?> </span> || <a href="javascript:window.print()">Print</a>  </span></h5>
												...
												<div class="tab-pane box active" id="list">
										                <table  class="table table-bordered datatable" id="table_export">
										                   ...
										                   <tr>
										                    	...
										                    	<td><?php echo number_format($this->am->total_starting_balance()+$this->am->total_income_search(),2)?></td>
										                    </tr>
										                ...
										                <table  class="table table-bordered datatable" id="table_export">
										                    ...
										                    <?php foreach($this->am->get_account() as $ac): ?> 	
										                        <tr>
																	...
																	<td>
																	    ...
																	    echo number_format($total_expense_search= $result[0]->total_expense,2);
																	 	?>


																	</td>

																	<td><?php echo number_format($total_amount-$total_expense_search,2)?></td>
										                    ...
										                    <?php endforeach; ?>
										                     ...
										                     <tr>
										                    	...
										                    	<td><?php echo number_format($total_amount=$this->am->total_starting_balance()+$this->am->total_income_search(),2)?></td>
										                    	<td><?php echo $this->am->total_expense_search()?></td>
										                    	<td><?php echo number_format($total_amount-$this->am->total_expense_search(),2)?></td>
