...
<!-- start: FIELDSET -->
						<div class="container-fluid container-fullw bg-white">
							...
							<!-- end of count bar -->
								<div class="col-md-12">
									<h5 class="over-title"><span class="text-bold">Expense Reports || From: <?=date('d/M/Y',strtotime($start_date))?> To: <?=date('d/M/Y',strtotime($end_date))?> </span> || <a href="javascript:window.print()">Print</a> </h5>
									...
									<div class="col-md-12 noprint">
											<fieldset>
												...
												<div class="row">
													...
													<?php echo form_open('accounting/expense_report_search' , array('roll' => 'form','method' => 'get', 'enctype' => 'multipart/form-data'));?>
										                ...
										                <table  class="table table-bordered datatable" id="table_export">
										                   ...
										                   <?php foreach($this->am->get_expense_search() as $inc): ?> 	
										                        <tr>
																	...
																	<td><?=$inc->expense_ref?></td>
																	<td><?=$inc->expense_note?></td>
