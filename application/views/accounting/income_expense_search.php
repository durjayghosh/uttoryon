...
<!-- start: FIELDSET -->
						<div class="container-fluid container-fullw bg-white">
							...
							<!-- end of count bar -->
								<div class="col-md-12">
									<h5 class="over-title"><span class="text-bold">Income V/S Expense || From: <?=date('d/M/Y',strtotime($start_date))?> To: <?=date('d/M/Y',strtotime($end_date))?> </span> || <a href="javascript:window.print()">Print</a> </h5>
									...
									<div class="col-md-12 noprint">
											<fieldset>
												...
												<div class="row">
													...
													<?php echo form_open('accounting/income_expense_search' , array('roll' => 'form','method' => 'get', 'enctype' => 'multipart/form-data'));?>
										                ...
										                <table  class="table table-bordered datatable" id="table_export">
										                	<thead>
										                		<tr>
										                    		...
										                    		<th class="noprint"><div><?php echo get_phrase('options');?></div></th>
																</tr>
															</thead>
										                    <tbody>
										                   <?php foreach($this->am->get_income_search() as $inc): ?> 	
										                        <tr>
																	<td>
																	...
																	<td class="noprint"><a data-toggle="tooltip" data-placement="top" title="Edit" href="<?=base_url()?>accounting/edit_income/<?=$inc->ai_id?>"> <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
										                    ...
										                    <tr>
										                    	<td></td><td></td>
										                    	<td>Total</td>
										                    	<td><?php echo $this->am->total_income_search()?></td>
										                    </tr>
											...
											<fieldset>
												...
												<div class="tab-pane box active" id="list">
										                <table  class="table table-bordered datatable" id="table_export">
										                	<thead>
										                		<tr>
										                    		<th><div><?php echo get_phrase('Expense For');?></div></th>
										                    ...
										                    <tbody>
										                   <?php foreach($this->am->get_expense_search() as $inc): ?> 	
										                        <tr>
																	<td>
																	...
																	<td class="noprint"><a data-toggle="tooltip" data-placement="top" title="Edit" href="<?=base_url()?>accounting/edit_expense/<?=$inc->ae_id?>"> <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
										                    ...
										                    <?php endforeach; ?>
										                     ...
										                     <tr>
										                    	<td></td><td></td>
										                    	<td>Total</td>
										                    	<td><?php echo $this->am->total_expense_search()?></td>
										                    </tr>
