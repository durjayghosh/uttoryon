						...
						?>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                		<h4 class="panel-title"> <i class="fa fa-shirtsinbulk"></i>
                                                    ...
                                                    <td>
														...
														<div class="btn-group">
															...
															<ul class="dropdown-menu1">
																<!-- <li>
                                                                <a href="<?=base_url()?>super_admin/class_routine" >
                                                         ...
                                                         <!-- <li>
                                                            <a href="<?=base_url()?>super_admin/class_routine" onclick="confirm_modal('<?php echo base_url();?>super_admin/class_routine/delete/<?php echo $row2['class_routine_id'];?>');">
