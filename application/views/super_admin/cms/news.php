...
echo form_open_multipart("super_admin/insert_news");?>
<table class="table table-striped table-bordered table-hover" id="angel_data_table">
    <tr>
        <td align="center" class="alert alert-info" colspan="6"> <h1> Insert New News </h1></td>
    </tr>
    <tr>
    ...
    <tr>
        <td align="right">News Attachment:</td>
