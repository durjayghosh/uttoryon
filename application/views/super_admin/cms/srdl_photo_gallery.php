...
echo form_open_multipart('super_admin/srdl_photo_gallery_upload');?>

<table class="table table-striped table-bordered table-hover" id="angel_data_table">
    <tr>
        <td align="center" class="alert alert-info" colspan="6"> <h1>Upload Images For SRDL Gallery</h1></td>
    </tr>
    <tr>
...
<table class="table table-striped table-bordered table-hover" id="angel_data_table">
   ...
   <?php $n=1;foreach ($this->srm->srdl_getData() as $row) { 
    ...
    <tr align="center">
        ...
        <td><img src="<?php echo base_url() .'uploads/srdl_gallary/'.$row->file_name ?>" width="80" height="80"></td>
        <td><a class="btn btn-success" href="edit_srdl_photo_gallery/<?php echo $row->id ?>">Edit</a></td>
        <td><a class="btn btn-danger" href="delete_srdl_photo_gallery/<?php echo $row->id ?>">Delete</a></td>
    </tr>
<?php } ?>
</table>
