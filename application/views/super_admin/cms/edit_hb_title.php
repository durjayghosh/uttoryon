...
echo form_open_multipart('super_admin/update_hb_title');?>

<table class="table table-striped table-bordered table-hover" id="angel_data_table">
	<tr>
    	<td align="center" class="alert alert-info" colspan="6"> <h1>Update Home Banner Title</h1></td>
    </tr>
    <tr>
    ...
    <tr>
    	<td><img src="<?php echo base_url() .'uploads/home_banner/'.$r->file_name ?>" width="80" height="80"></td>
    </tr>
