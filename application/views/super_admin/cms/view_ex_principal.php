...
<table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
	 <h1>View All Retired Principal</h1>
     <thead>
    <tr>
    	<th>Id No</th>
        <th>Full Name</th>
   ...
   <?php foreach ($this->exp_m->getData() as $row) { 
    ...
    <tr align="center">
        ...
        <td><img src="<?php echo base_url() .'uploads/ex_principal/'.$row->photo ?>" width="80" height="80" class="img-circle"></td>
        
        <td><a class="btn btn-primary" href="edit_ex_principal/<?php echo $row->id ?>">Edit</a></td>
        <td><a class="btn btn-danger" href="delete_ex_principal/<?php echo $row->id ?>">Delete</a></td>
    </tr>
<?php } ?>
</tbody>
</table>
