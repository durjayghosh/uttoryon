...
echo form_open_multipart("super_admin/insert_ex_principal");?>
<table class="table table-striped table-bordered table-hover" id="angel_data_table">
    <tr>
        <td align="center" class="alert alert-info" colspan="6"> <h1> Insert Retired Principal </h1></td>
    </tr>
    <tr>
    ...
    <tr>
    <td></td>
        <td align="left" ><a class="btn btn-danger" href="view_ex_principal">Cancel</a>
