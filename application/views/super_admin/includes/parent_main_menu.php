					...
					<nav>
						...
						<ul class="main-navigation-menu">
								...
								<nav id="cl-effect-14" class="links cl-effect-14">
									...
									<?php $classes	=	$this->db->get('class')->result_array();
					                  ...
					                  <li class="<?php if ($page_name == 'subject') echo 'active';?>">
					                      ...
					                      <a href="<?php echo base_url();?>parents/subject/<?php echo $row['class_id'];?>">
							...
							<li class="<?php if($page_name == 'notice')echo 'active';?> ">
								...
								<a href="<?php echo base_url(); ?>parents/view_notices">
							...
							<li class="<?php if($page_name == 'notice')echo 'active';?> ">
								...
								<a href="<?php echo base_url(); ?>parents/view_news">
							...
							<li class="<?php if($page_name == 'notice')echo 'active';?> ">
								...
								<a href="<?php echo base_url(); ?>parents/view_events">
