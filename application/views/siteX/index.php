...
<div id="edm_s4s_body" class="container-fluid">
	<div class="row">
		...
		<div class="edm_s4s_middle col-sm-8">
			<?php include "includes/edm_slider.php" ?>    
			<?php include "includes/edm_home_content.php" ?>
			<?php include "includes/edm_content_bottom.php" ?>
		</div>
		<div class="col-sm-2">
