...
class Parents extends CI_Controller
{
    ...
    public function nnemodels(){
     ...
     public function layout(){
        ...
        $this->load->view('super_admin/includes/parent_main_menu');
        $this->load->view('super_admin/includes/menu_top_logo');
        $this->load->view('super_admin/includes/top_bar_parent');
    ...
    function dashboard()
    {
       ...
       $this->load->view('backend/parent/dashboard', $page_data);
        $this->footer_layout();
    }
    ...
    function view_notices(){
        $this->layout();
        $this->load->model("notice_model","nm");
        $this->load->view('backend/parent/view_notices');
        $this->footer_layout();
    }
     ...
     function view_news(){
        ...
        $this->load->view('backend/parent/view_news');
        $this->footer_layout();
    }
     ...
     function view_events(){
        $this->layout();
        $this->load->model("event_model","em");
        $this->load->view('backend/parent/view_events');
        $this->footer_layout();
    }
